    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
				...
				<div class="form-group">
                    <label for="grace_period" class="col-sm-4 control-label">Grace Period (mins)</label>

                    <div class="col-sm-6">
                      <div class="bootstrap-timepicker">
                        <input type="text" class="form-control" id="grace_period" name="grace_period" required>
                      </div>
                    </div>
                </div>
          	</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_time_in" class="col-sm-4 control-label">Time In</label>
                ...
                <div class="form-group">
                    <label for="edit_time_out" class="col-sm-4 control-label">Time out</label>
				...
				<div class="form-group">
                    <label for="edit_grace_period" class="col-sm-4 control-label">Grace Period (mins)</label>

                    <div class="col-sm-6">
                      <div class="bootstrap-timepicker">
                        <input type="text" class="form-control" id="edit_grace_period" name="grace_period" required>
                      </div>
                    </div>
                </div>
          	</div>
