    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Add Pay</b></h4>
          	</div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                      <select class="form-control" name="description" id="description" required>
                        <option value="" selected>- Select -</option>
                        <option value="Vacation Leave">Vacation Leave Pay</option>
                        <option value="Sick Leave">Sick Leave Pay</option>
                        <option value="Differential Pay">Differential Pay</option>
                      </select>
                    </div>
                </div>
                <div class="form-group">
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="pay_edit.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9"> 
                      <select class="form-control" name="description" id="edit_description" required>
                        <option value="description" selected>- Select -</option>
                        <option value="Vacation Leave">Vacation Leave Pay</option>
                        <option value="Sick Leave">Sick Leave Pay</option>
                        <option value="Differential Pay">Differential Pay</option>
                      </select>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="pay_delete.php">
            		<input type="hidden" class="pid" name="id">
