            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                  <th class="hidden"></th>
                  <th>Payout Period</th>
                  <th style='text-align: center;' colspan='6'>Gross Income Inclusion</th>
                  <th></th>
                </thead>
                <thead>
                  <th class="hidden"></th>
                  <th>Payout Period</th>
                  <th>Basic Salary</th>
                  <th style='text-align: center;' colspan='6'>Loans</th>
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      $('.id').val(response.id);
      $('#edit_department').val(response.departments);
