<?php
	...
	if(isset($_POST['edit'])){
		...
		$sql = "UPDATE pagibig_table SET range_from = '$range_from',range_to = '$range_to',
				employerShare = '$employerShare',employeeShare = '$employeeShare',
				totalMonthlyPremium = '$totalMonthly'
				WHERE id = '$id'";
		if($conn->query($sql)){
			$_SESSION['success'] = 'Pagibig Table updated successfully';
		}
		else{
	...
	header('location: pagibigTable.php');
